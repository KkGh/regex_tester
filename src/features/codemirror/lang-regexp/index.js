...
import { LRLanguage, indentNodeProp, foldNodeProp, HighlightStyle, LanguageSupport, syntaxHighlighting } from '@codemirror/language';
...
const lookahead = new ExternalTokenizer((input, stack) => {
...
const regexpLanguage = LRLanguage.define({
    parser: parser.configure({
        props: [
            ...
            styleTags({
                "| Boundary Quantifier!": tags.meta,
                "AtomEscape!": tags.escape,
                "CharacterClass/...": tags.bracket,
                "Lookaround/...": tags.paren,
                "CapturingGroup/...": tags.paren,
                "NonCapturingGroup/...": tags.paren,
            })
        ]
    }),
    languageData: {
...
const regexpHighlightStyle = HighlightStyle.define([
    { tag: tags.meta, color: "#6f991a" },
    { tag: tags.escape, color: "#ffa802" },
    { tag: tags.bracket, backgroundColor: "#533a3a" },
    { tag: tags.paren, backgroundColor: "#244069" },
]);
function regexp() {
    return new LanguageSupport(regexpLanguage, syntaxHighlighting(regexpHighlightStyle));
}

export { regexp, regexpHighlightStyle, regexpLanguage };
