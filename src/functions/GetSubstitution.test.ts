...
describe("GetSubstitution", () => {
    it("replaces string with template", () => {
        ...
        for (const match of matches) {
            ...
            const sub = GetSubstitution(matched, str, position, captures, namedCaptures, replacementTemplate);
            result.push(sub);
        }
    ...
    it("replaces string with special template", () => {
        ...
        expect(sub).toEqual("$__banana__banana__banana__$2__$99__apple,__,orange__$<");
    });
